...
hours_studied=st.number_input("How many hours did the student study per day?",max_value=24,value=None,placeholder=" ")
previous_score=st.number_input("Enter the student's past academic score",value=None,placeholder=" ")
sleep_hours=st.number_input("How many hours does the student sleep?",max_value=24,value=None,placeholder=" ")
